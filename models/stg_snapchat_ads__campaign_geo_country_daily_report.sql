...
final as (
    ...
    select
        ...
        {{ snapchat_ads_fill_pass_through_columns(pass_through_fields=var('snapchat_ads__campaign_daily_report_passthrough_metrics'), except=(var('snapchat_ads__conversion_fields') + ['conversion_purchases_value'])) }}
